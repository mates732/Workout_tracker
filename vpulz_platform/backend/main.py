...
from vpulz_platform.backend.api.exercises import router as exercises_router
from vpulz_platform.backend.api.profile import router as profile_router
...
app.include_router(exercises_router, dependencies=[Depends(require_api_key)])
app.include_router(profile_router, dependencies=[Depends(require_api_key)])
